 ...
 */
public class SalesForecasterTest extends TestCase {

	public SalesForecasterTest(String name) {
		super(name);
	}
	...
	public void testRegressionForecastTwoTargetsConfidenceIntervals() throws Exception {
		...
		Instances wine = getData("sales.arff");
	...
	public static Test suite() {
		return new TestSuite(weka.classifiers.timeseries.SalesForecasterTest.class);
	}
